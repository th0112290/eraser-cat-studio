...
import {
  assessAutoSelectionRiskWithDeps,
  assessFinalQualityFirewallWithDeps,
  assessQualityEmbargoWithDeps,
  assessRigStabilityWithDeps,
  isStrongFrontMasterCandidateWithDeps
} from "./characterGenerationGating";
...
function buildCharacterGenerationGatingDeps() {
  return {
    CHARACTER_VIEWS,
    stableStringify,
    isMascotTargetStyle,
...
export function assessRigStability(input: {
  ...
  return assessRigStabilityWithDeps(input, buildCharacterGenerationGatingDeps()) as RigStabilityDiagnostics;
}
...
export function isStrongFrontMasterCandidate(
  ...
  return isStrongFrontMasterCandidateWithDeps(
    { candidate, targetStyle, acceptedScoreThreshold, speciesId },
    buildCharacterGenerationGatingDeps()
  );
}
...
function resolveSelectionWorstRuntimeBucket(input: {
  selectedByView?: Partial<Record<CharacterView, ScoredCandidate>>;
  targetStyle?: string;
}): CandidateRuntimeBucketLevel | undefined {
  return resolveWorstRuntimeBucketLevel(
...
export function assessAutoSelectionRisk(input: {
  ...
  return assessAutoSelectionRiskWithDeps(input, buildCharacterGenerationGatingDeps()) as SelectionRiskAssessment;
}
...
export function assessQualityEmbargo(input: {
  ...
  return assessQualityEmbargoWithDeps(input, buildCharacterGenerationGatingDeps()) as QualityEmbargoAssessment;
}
...
export function assessFinalQualityFirewall(input: {
  ...
  return assessFinalQualityFirewallWithDeps(input, buildCharacterGenerationGatingDeps()) as FinalQualityFirewallAssessment;
}
...
export async function handleGenerateCharacterAssetsJob(input: {
  ...
  const selectionOutcome = await runGenerationLifecycle({
    ...
    prisma,
    sessionId,
    payloadEpisodeId: payload.episodeId,
    providerCallLogs,
    writeGenerationProgress,
    summarizeBestScores,
    upsertSessionCandidates,
