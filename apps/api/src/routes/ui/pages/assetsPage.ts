...
export function buildAssetsPageBody(input: AssetsPageBodyInput): string {
  ...
  const heroSection = `<section class="card asset-hero"><div class="asset-section-head"><div><p class="asset-kicker">Review Workbench</p><h2>Review Queue + Inspection</h2><p class="asset-copy">Use this surface for intake, queue review, inspection, and routing the next handoff. <a href="/ui/studio">Studio</a> stays the orchestration hub.</p></div><div class="asset-hero-links"><a href="/ui/studio" class="asset-link-chip">Open Studio</a><a href="/ui/character-generator" class="asset-link-chip">Open Character Generator</a></div></div><div class="asset-flow-grid"><div class="asset-flow-step"><strong>Intake</strong><span>Push a new reference or land here from Studio.</span></div><div class="asset-flow-step"><strong>Queue</strong><span>Filter the current slice and pick the asset that needs attention.</span></div><div class="asset-flow-step"><strong>Inspect</strong><span>Confirm QC, storage keys, and local previews before handoff.</span></div><div class="asset-flow-step"><strong>Route</strong><span>Carry the selected asset into Studio or Character Generator.</span></div></div></section>`;
