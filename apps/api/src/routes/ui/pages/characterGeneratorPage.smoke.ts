...
assertIncludes(html, "Recent Generation Jobs", "jobs section heading");
...
assertIncludes(statusScript, "risk=", "selection risk status fragment");
assertIncludes(statusScript, "embargo=", "quality embargo status fragment");
assertIncludes(statusScript, "firewall=", "final quality firewall status fragment");
...
assertIncludes(statusScript, "pf=", "preflight status fragment");
