...
.shell-brand h1{margin:0;font-size:30px;letter-spacing:-.04em;color:#f1fbff}
.shell-brand p{margin:0;color:#a5bbc1;line-height:1.55}
...
.shell-shortcuts{display:flex;gap:8px;align-items:center}
.shell-nav-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}
.shell-nav-group{display:grid;gap:10px;padding:12px;border:1px solid #28464f;border-radius:18px;background:linear-gradient(180deg,#10252d,#132f39)}
...
.shell-nav-links a{display:flex;justify-content:space-between;gap:12px;align-items:center;padding:9px 10px;border-radius:12px;border:1px solid transparent;background:#173540;color:#e8fbff;text-decoration:none;transition:.18s ease}
...
.page-intro,.detail-hero,.compare-hero{position:relative;overflow:hidden;display:grid;gap:12px;padding:18px;border-radius:18px;border:1px solid #244650;background:linear-gradient(150deg,#11242c 0%,#173340 60%,#12312d 100%);box-shadow:0 16px 36px #00000022;color:#eefbfd}
...
.page-intro h2,.detail-hero h2,.compare-hero h2{margin:0;font-size:28px;letter-spacing:-.04em;color:#f5fdff}
.page-intro-head,.section-head{display:flex;justify-content:space-between;gap:10px;align-items:center;flex-wrap:wrap}
.hero-grid{display:grid;grid-template-columns:minmax(0,1.35fr) minmax(280px,.95fr);gap:14px;align-items:start}.hero-panel,.status-panel{padding:14px;border-radius:16px;border:1px solid #28464f;background:#15303a}
.status-list{display:grid;gap:8px;margin:6px 0 0}.status-row{display:flex;justify-content:space-between;align-items:center;gap:10px;padding:8px 10px;border:1px solid #325562;background:#10242d;border-radius:10px;color:#e9f7fb}.status-row strong{color:#f4fdff}
...
.sticky-action-bar{position:sticky;top:148px;padding:12px;border-radius:16px;border:1px solid #c9dfe3;background:#fffffff0;box-shadow:0 10px 24px #11354614}
